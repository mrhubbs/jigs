...
import { map, reduce, compose, curry } from 'crocks'
...
const loadResource = curry((rootPath, resPath) => {
...
// const loadLayout = curry((config, layoutPath) => compose(
//   validateLayout,
//   loadResource(config.dirs.layouts)
// )(layoutPath))

// String -> String -> [ String ]
const getPaths = (rootPath, ext) => glob.sync(
