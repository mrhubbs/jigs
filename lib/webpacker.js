...
// TODO: if this client config doesn't exist, then we shouldn't load it
const clientWebpackConfig = require(path.join(process.cwd(), 'webpack.config.js'))
...
const webpackConfig = Object.assign(defaultWebpackConfig, clientWebpackConfig)
